...
void newState(std::list<State> &states, const char *token, const char *lexem, bool pre)
{
    const char * ident = 0;
...
void newState(std::list<State> &states, const char *token,  char lexem)
{
